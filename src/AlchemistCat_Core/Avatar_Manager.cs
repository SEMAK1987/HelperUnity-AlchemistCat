...
public class Avatar_Manager : MonoBehaviour
{
    ...
    private static readonly string[] MasteryRankNamesRU = new string[]
    {
        ...
        "Стадия Новичка (Божественный)", "Стадия Понимания (Божественный)", "Стадия Мастерства (Божественный)"
    };

    private static readonly int[] MasteryRankThresholds = new int[]
    {
        100, 300, 500, 1000, 5000, 20000,
        90000, 130000, 160000, 210000, 260000,
        300000, 350000, 400000, 460000, 500000,
        580000, 650000, 760000, 880000, 1000000,
