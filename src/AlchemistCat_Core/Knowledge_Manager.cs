...
public class Knowledge_Manager : MonoBehaviour
{
    ...
    public void InitDefaultRanks() // Наполнение структуры данных 21 алхимическим рангом и 4 этапами
    {
        ...
        // Этап V: Божественная Алхимия (Ранги 22–24)
        AddRank(22, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Новичка (Божественный)", "Divine Novice Stage", "Ilahi Acemi Asamasi", 1500000, new Color(1f, 0.60f, 0.80f, 1f), "Понимание основ и рождение нового объекта. Открытие секретных территорий и таинств."); // Ранг 22
        AddRank(23, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Понимания (Божественный)", "Divine Understanding Stage", "Ilahi Anlayis Asamasi", 3000000, new Color(0.80f, 0.60f, 1f, 1f), "Просветление сознания и подчинение стихий высшего порядка. Создание легендарных артефактов."); // Ранг 23
        AddRank(24, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Мастерства (Божественный)", "Divine Mastery Stage", "Ilahi Ustalik Asamasi", 5000000, new Color(0.60f, 0.90f, 1f, 1f), "Абсолютное слияние с энергией космоса. Величие создателя вселенных и владельца божественных чертогов."); // Ранг 24
    }
