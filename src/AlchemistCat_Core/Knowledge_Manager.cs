...
public class Knowledge_Manager : MonoBehaviour
{
    ...
    public bool isKnowledgeCompleted = false; // Достигнут ли максимальный ранг мастерства
    ...
    {
        public int rankIndex; // Порядковый номер ранга (1 - 24)
        public string stageNameRU; // Название этапа алхимии
    ...
    [Header("Список 24 Рангов Мастерства (5 Этапов)")]
    ...
    private void Awake() // Инициализация синглтона, подписок на события кнопок и скролла
    {
        ...
        InitDefaultRanks(); // Инициализация базы данных 24 рангов алхимии
    }
    ...
    public void InitDefaultRanks() // Наполнение структуры данных 24 алхимическим рангами
    {
        ...
        AddRank(5, "Этап I: Ученик — Основы и базовые экстракты", "Знаток пропорций", "Proportion Master", "Oran Ustasi", 5000, new Color(0.50f, 0.90f, 0.80f, 1f), "Идеальное соблюдение дозировок без риска взрыва.");
        AddRank(6, "Этап I: Ученик — Основы и базовые экстракты", "Сертифицированный ученик", "Certified Apprentice", "Sertifikali Cirak", 20000, new Color(0.55f, 0.95f, 0.90f, 1f), "Завершение базового обучения и допуск к сложным реактивам.");

        // Этап II: Адепт (Ранги 7–11)
        AddRank(7, "Этап II: Адепт — Нестабильные субстанции и катализаторы", "Практик масел", "Oil Practitioner", "Yag Uygulayicisi", 90000, new Color(0.30f, 0.70f, 1f, 1f), "Варка густых эфирных масел и настоек длительного действия.");
        AddRank(8, "Этап II: Адепт — Нестабильные субстанции и катализаторы", "Дистиллятор", "Distiller", "Damitici", 130000, new Color(0.35f, 0.75f, 1f, 1f), "Многоступенчатая перегонка редких магических спиртов.");
        AddRank(9, "Этап II: Адепт — Нестабильные субстанции и катализаторы", "Мастер ферментации", "Fermentation Master", "Mayalama Ustasi", 160000, new Color(0.40f, 0.80f, 1f, 1f), "Ускорение биологических реакций лунными дрожжами.");
        AddRank(10, "Этап II: Адепт — Нестабильные субстанции и катализаторы", "Каталитический химик", "Catalytic Chemist", "Katalitik Kimyager", 210000, new Color(0.50f, 0.85f, 1f, 1f), "Использование катализаторов для синтеза редких минералов.");
        AddRank(11, "Этап II: Адепт — Нестабильные субстанции и катализаторы", "Старший фармацевт", "Senior Pharmacist", "Kidemli Eczaci", 260000, new Color(0.60f, 0.90f, 1f, 1f), "Создание сильнодействующих лекарств и противоядий.");

        // Этап III: Магистр (Ранги 12–16)
        AddRank(12, "Этап III: Магистр — Эфир, пустота и кристаллы", "Эфирный экспериментатор", "Aether Experimenter", "Eter Deneycisi", 300000, new Color(0.80f, 0.50f, 1f, 1f), "Улавливание невидимых эфирных потоков в стеклянные сосуды.");
        AddRank(13, "Этап III: Магистр — Эфир, пустота и кристаллы", "Кристаллограф", "Crystallographer", "Kristalograft", 350000, new Color(0.85f, 0.55f, 1f, 1f), "Выращивание кристаллов маны идеальной геометрической формы.");
        AddRank(14, "Этап III: Магистр — Эфир, пустота и кристаллы", "Мастер трансмутации", "Transmutation Master", "Donusum Ustasi", 400000, new Color(0.90f, 0.60f, 1f, 1f), "Превращение свинца в медь и серебро силой мысли и тепла.");
        AddRank(15, "Этап III: Магистр — Эфир, пустота и кристаллы", "Вивисектор сущностей", "Essence Vivisector", "Oz Kasifi", 460000, new Color(0.95f, 0.65f, 1f, 1f), "Разделение духовной и физической материи компонентов.");
        AddRank(16, "Этап III: Магистр — Эфир, пустота и кристаллы", "Архимагистр рецептуры", "Archmagister of Formulas", "Formul Basbuyucusu", 500000, new Color(1f, 0.70f, 0.95f, 1f), "Создание собственных уникальных формул для великих свитков.");

        // Этап IV: Великий Алхимик (Ранги 17–21)
        AddRank(17, "Этап IV: Великий Алхимик — Легенды и Первозданная магия", "Повелитель температур", "Lord of Temperatures", "Sicaklik Efendisi", 580000, new Color(1f, 0.80f, 0.30f, 1f), "Контроль абсолютного нуля и пламени феникса.");
        AddRank(18, "Этап IV: Великий Алхимик — Легенды и Первозданная магия", "Ткач реальности", "Reality Weaver", "Gerceklik Dokuyucusu", 650000, new Color(1f, 0.85f, 0.35f, 1f), "Изменение физических свойств пространства вокруг котла.");
        AddRank(19, "Этап IV: Великий Алхимик — Легенды и Первозданная магия", "Конструктор душ", "Soul Constructor", "Ruh Yapicisi", 760000, new Color(1f, 0.90f, 0.40f, 1f), "Вдохновение жизни в гомункулов и волшебных стражей.");
        AddRank(20, "Этап IV: Великий Алхимик — Легенды и Первозданная магия", "Хранитель Первоматерии", "Keeper of Prima Materia", "Ilk Maddenin Bekcisi", 880000, new Color(1f, 0.95f, 0.50f, 1f), "Владение изначальной субстанцией творения Вселенной.");
        AddRank(21, "Этап IV: Великий Алхимик — Легенды и Первозданная магия", "Создатель Философского камня", "Creator of Philosopher's Stone", "Felsefe Tasi Yaraticisi", 1000000, new Color(1f, 0.98f, 0.60f, 1f), "Вершина мастерства: вечная жизнь и бесконечное золото.");

        // Этап V: Высшая Божественная Алхимия (Ранги 22–24)
        AddRank(22, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Новичка (Божественный)", "Divine Novice Stage", "Ilahi Acemi Asamasi", 1500000, new Color(1f, 0.60f, 0.80f, 1f), "Понимание основ и рождение нового объекта. Открытие секретных территорий и таинств.");
        AddRank(23, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Понимания (Божественный)", "Divine Understanding Stage", "Ilahi Anlayis Asamasi", 3000000, new Color(0.80f, 0.60f, 1f, 1f), "Просветление сознания и подчинение стихий высшего порядка. Создание легендарных артефактов.");
        AddRank(24, "Этап V: Высшая Божественная Алхимия — Создатели Миров", "Стадия Мастерства (Божественный)", "Divine Mastery Stage", "Ilahi Ustalik Asamasi", 5000000, new Color(0.60f, 0.90f, 1f, 1f), "Абсолютное слияние с энергией космоса. Величие создателя вселенных и владельца божественных чертогов.");
    }
    ...
    public void BuildAllRankCardsUI()
    {
        ...
        if (knowledgeContent.childCount >= 24)
        {
    ...
    private void CreateRankCardUI(AlchemyRankInfo rank, int listIndex, int currentRankIndex)
    {
        ...
        if (isCurrent)
        {
            bgImg.color = new Color(0.18f, 0.28f, 0.38f, 0.95f);
        }
        else if (isCompleted)
        {
            bgImg.color = new Color(0.12f, 0.20f, 0.16f, 0.90f);
        }
        else
        {
            bgImg.color = new Color(0.10f, 0.09f, 0.15f, 0.85f);
        }
